  ...
  return (
    <section className="output md:w-full p-3 mt-6 md:mt-9 space-y-1 md:p-3 h-32 md:h-28 -mb-24 md:-mb-24 bg-white rounded-xl flex flex-col md:flex-row justify-evenly text-center md:text-left h-64 md:justify-between">
      <div className="md:px-5 w-full break-all">
        ...
        <p className="ip-info text-sm sm:text-base md:text-lg md:mt-2 h-0 font-bold text-lg md:text-xl">
          {data?.ip}
        </p>
      </div>
      ...
      <div className="md:px-5 md:border-l md:border-gray-300 md:border-solid w-full break-all">
        ...
        <p className="location-info text-sm sm:text-base md:text-lg md:mt-2 font-bold text-lg md:text-xl">
          {data?.city === undefined
            ? "--"
      ...
      <div className="md:px-5 md:border-l md:border-gray-300 md:border-solid w-full break-all">
        ...
        <p className="timezone-info text-sm sm:text-base md:text-lg md:mt-2 font-bold text-lg md:text-xl">
      ...
      <div className="md:px-5 md:border-l md:border-gray-300 md:border-solid w-full break-all">
        ...
        <p className="isp-info text-sm sm:text-base md:text-lg md:mt-2 font-bold text-lg md:text-xl">
